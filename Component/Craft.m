classdef Craft < six_dof
    ...
    methods(Access = public)
        ...
        function dif = get_dif_sim(obj, x, envs)
            ...
            ctrl.u1=x(31); ctrl.u2 = x(32);ctrl.u3 = x(32);ctrl.u4 = x(32);ctrl.omega = x(35);
            ctrl=obj.Manipulate.allocate(ctrl);
            ...
            dif = obj.get_dif(state, ctrl, envs, 'sim');%%没有sim?
